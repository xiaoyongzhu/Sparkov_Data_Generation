...
python3 datagen_customer.py 100 4144 profiles/main_config.json > ./output/customers.csv

python3 datagen_transaction.py ./output/customers.csv ./profiles/adults_2550_female_rural.json 1-1-2021 12-31-2022 >./output/adults_2550_female_rural.csv &
